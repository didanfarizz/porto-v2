...
export default function Tabs() {
  ...
  const skills = [
    {
      icon: (
        <Image src={'/icons/HTML5.png'} alt='html' width={48} height={48} />
      ),
      name: 'HTML',
    },
    {
      icon: (
        <Image src={'/icons/CSS3.png'} alt='css' width={48} height={48} />
      ),
      name: 'CSS',
    },
    {
      icon: (
        <Image src={'/icons/JavaScript.png'} alt='js' width={48} height={48} />
      ),
      name: 'JavaScript',
    },
    {
    ...
    {
      icon: (
        <Image src={'/icons/Next.js.png'} alt='nextjs' width={48} height={48} />
      ),
      name: 'Next.js',
    },
    {
      icon: (
        <Image src={'/icons/Vite.js.png'} alt='vite' width={48} height={48} />
      ),
      name: 'Vite',
    },
    {
      icon: (
        <Image src={'/icons/Node.js.png'} alt='nodejs' width={48} height={48} />
      ),
      name: 'Node.js',
    },
    {
      icon: (
        <Image src={'/icons/Laravel.png'} alt='laravel' width={48} height={48} />
      ),
      name: 'Laravel',
    },
    {
      icon: (
        <Image src={'/icons/CodeIgniter.png'} alt='ci' width={48} height={48} />
      ),
      name: 'CodeIgniter',
    },
    {
      icon: (
        <Image src={'/icons/Tailwind.png'} alt='tailwind' width={48} height={48} />
      ),
      name: 'Tailwind CSS',
    },
    {
      icon: (
        <Image src={'/icons/Bootstrap.png'} alt='bootstrap' width={48} height={48} />
      ),
      name: 'Bootstrap',
    },
    {
      icon: (
        <Image src={'/icons/MySQL.png'} alt='mysql' width={48} height={48} />
      ),
      name: 'MySQL',
    },
    {
      icon: (
        <Image src={'/icons/Git.png'} alt='git' width={48} height={48} />
      ),
      name: 'Git',
    },
    {
    ...
    {
      icon: (
        <Image src={'/icons/Figma.png'} alt='Figma' width={48} height={48} />
      ),
      name: 'Figma',
    },
  ];
                ...
                <div>
                  <div className="grid grid-cols-5 gap-10">
                    {skills.map((skill, index) => (
                      <div
                        key={index}
                        className="bg-transparent bg-opacity-10 p-7 hover:shadow-primary hover:shadow-lg hover:transition-shadow hover:ease-in-out bg-white border-primary border rounded-lg shadow-md flex flex-col items-center text-center"
                      >
